...
var reverseKeywords = {};
for (var key in index$5) {
	if (index$5.hasOwnProperty(key)) {
		reverseKeywords[index$5[key]] = key;
	}
}
...
convert.rgb.keyword = function (rgb) {
	...
	for (var keyword in index$5) {
		if (index$5.hasOwnProperty(keyword)) {
			var value = index$5[keyword];
...
var index$2 = createCommonjsModule(function (module) {
	...
	var wrapAnsi16 = function wrapAnsi16(fn, offset) {
		return function () {
			var code = fn.apply(index$3, arguments);
	...
	var wrapAnsi16m = function wrapAnsi16m(fn, offset) {
		return function () {
			var rgb = fn.apply(index$3, arguments);
	...
	function assembleStyles() {
		...
		try {
			for (var _iterator2 = _getIterator(_Object$keys(index$3)), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
				var key = _step2.value;

				if (_typeof(index$3[key]) !== 'object') {
					continue;
				}

				var suite = index$3[key];
...
var toHumanReadableAnsi = function toHumanReadableAnsi(text) {
  return text.replace(index$7(), function (match, offset, string) {
    switch (match) {
      case index$2.red.close:
      case index$2.green.close:
      case index$2.cyan.close:
      case index$2.bgRed.close:
      case index$2.bgGreen.close:
      case index$2.bgCyan.close:
      case index$2.reset.open:
      case index$2.reset.close:
        return '</>';
      case index$2.red.open:
        return '<red>';
      case index$2.green.open:
        return '<green>';
      case index$2.cyan.open:
        return '<cyan>';
      case index$2.bgRed.open:
        return '<bgRed>';
      case index$2.bgGreen.open:
        return '<bgGreen>';
      case index$2.bgCyan.open:
        return '<bgCyan>';
      case index$2.dim.open:
        return '<dim>';
      case index$2.bold.open:
        return '<bold>';
      default:
        return '';
    }
...
var test$1 = function test(val) {
  return typeof val === 'string' && val.match(index$7());
};
